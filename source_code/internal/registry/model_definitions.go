...
// GetJumaModels returns the Juma.ai model definitions.
// These models are accessed through Juma's web API and include
// various OpenAI and Google models available on the platform.
func GetJumaModels() []*ModelInfo {
	return []*ModelInfo{
		// OpenAI models
		{
			ID:                  "juma-gpt-5.1",
			...
			OwnedBy:             "juma",
			Type:                "juma",
			DisplayName:         "GPT-5.1 (Juma)",
			Description:         "OpenAI GPT-5.1 accessed via Juma.ai",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
		},
		// Anthropic models via Bedrock
		{
			ID:                  "juma-claude-opus-4.5",
			Object:              "model",
			Created:             1761955200,
			OwnedBy:             "juma",
			Type:                "juma",
			DisplayName:         "Claude Opus 4.5 (Juma)",
			Description:         "Anthropic Claude Opus 4.5 accessed via Juma.ai (Bedrock)",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		// Google AI models
		{
			ID:                  "juma-gemini-3-pro",
			Object:              "model",
			Created:             1753142400,
			OwnedBy:             "juma",
			Type:                "juma",
			DisplayName:         "Gemini 3 Pro (Juma)",
			Description:         "Google Gemini 3 Pro accessed via Juma.ai",
			ContextLength:       1048576,
			MaxCompletionTokens: 65536,
		},
		// Nanobanana (Google Vertex AI) - Image Editing
		{
			ID:                  "juma-nanobanana-pro",
			Object:              "model",
			Created:             1733788800, // 2024-12-10
			OwnedBy:             "juma",
			Type:                "juma-image",
			DisplayName:         "Nanobanana Pro (Juma)",
			Description:         "Google Vertex AI Nanobanana image editing accessed via Juma.ai",
		},
	}
}
